...
\section{GraphQL API}
	...
	\subsection{Warstwa infrastruktury}
		...
		\subsubsection*{Dostęp do danych}
			...
			Stworzono w tym celu extension method \todo{przetłumaczyć jakoś},
			...
			które pozwala na lazy loading \todo{przetłumaczyć} pokrewnych encji.
			...
			\todo{sprawdzić wywołania SQL przy zagnieżdżaniu}
		...
		\subsubsection*{Rejestracja zależności}
			...
			Funkcja \verb|RegisterAssemblyTypes| skanuje assembly \todo{opisać jak działo}.
...
\section{Serwis uwierzytelniający}
	...
	\subsection{Logowanie}
		...
		\todo{screeny z networku przeglądarki}
