...
\section{Strona internetowa}
	...
	\subsection{Klient GraphQL}
		...
		\begin{lstlisting}[label=lst:apolloSettings, caption=Globalne ustawienia modułu Apollo, float=th]
		...
		\subsubsection*{Lokalny schemat GraphQL}
			...
			Jednak aby możliwe było zapisywanie danych do lokalnej bazy poprzez mutację \verb|updateSettings|,
