...
\section{Strona internetowa}
	...
	\subsection{Routing}
		...
		Dzięki niej każdy moduł aplikaji posiada zdefiniowany ro
	...
	\subsection{Motyw aplikacji}
		...
		przedstawionym na listingu~\ref{lst:appComponent}.
		Odpowiednia klasa aktyowowana jest na podstawie ustawień użytkownika.
