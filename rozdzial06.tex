...
\section{Widoki albumów}
	...
	\begin{figure}[H]
		...
		\begin{minipage}{.5\textwidth}
			\centering
			\includegraphics[width=0.75\linewidth]{rys06/explore.png}
			\caption{Widok wyświetlający listę albumów}
		\end{minipage}%
		\begin{minipage}{0.5\textwidth}
			\centering
			\includegraphics[width=0.75\linewidth]{rys06/album.png}
...
\section{Dodawanie oceny}
	...
	\begin{figure}[H]
		...
		\begin{minipage}{0.5\textwidth}
			\centering
			\includegraphics[width=0.75\linewidth]{rys06/rate.png}
...
\section{Rejestracja i logowanie}
	...
	\begin{figure}[H]
		...
		\begin{minipage}{0.5\textwidth}
			\centering
			\includegraphics[width=0.75\linewidth]{rys06/login.png}
...
\section{Jasny motyw}
	...
	\begin{figure}[H]
		...
		\begin{minipage}{0.5\textwidth}
			\centering
			\includegraphics[width=0.75\linewidth]{rys06/album_light.png}
			\caption{Widok przedstawiający szczegóły albumu}
